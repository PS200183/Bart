<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="w-full shrink-0 sm:px-6 lg:px-8">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->role == 'employee' || Auth::user()->role == 'admin')
                        ...
                        {{-- <x-nav-link :href="route('employee.klok')" :active="request()->routeIs('employee.klok')">
                            {{ __('Shifts') }}
                        </x-nav-link> --}}
                        
                        <x-nav-link :href="route('employee.sick')" :active="request()->routeIs('employee.sick')">
                            {{ __('Ziektemeldingen') }}
                        </x-nav-link>
                    @endif

<!-- Edit -->
<div class="modal fade" id="edit{{ $shift->name }}">
    <div class=" modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-left">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('shift.update', $shift->id)}}" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                      <input type="hidden" name="_method" value="PUT">

                    <div class="form-group">
                        <label for="name" class="col-sm-6 control-label">Naam</label>
                    ...
                    <div class="form-group">
                        <label for="edit_time_in" class="col-sm-3 control-label">Begintijd</label>
                    ...
                    <div class="form-group">
                        <label for="edit_time_out" class="col-sm-3 control-label">Eindtijd</label>
...
<!-- Delete -->
<div class="modal fade" id="delete{{ $shift->name }}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header " style="align-items: center">

                <h4 class="modal-title "><span class="employee_id">Werktijd verwijderen</span></h4>
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('shift.destroy', $shift->id) }}">
                    ...
                    <div class="text-center">
                        <h6>Deze shift verwijderen:</h6>
                        <h2 class="bold del_employee_name">{{ $shift->name}}</h2>
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i
